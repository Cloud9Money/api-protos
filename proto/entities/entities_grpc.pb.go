...
func (UnimplementedEntityServiceServer) GetBusinessDirectors(context.Context, *GetBusinessDirectorsRequest) (*GetBusinessDirectorsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetBusinessDirectors not implemented")
}
func (UnimplementedEntityServiceServer) ListLLCShareholders(context.Context, *ListLLCShareholdersRequest) (*ListLLCShareholdersResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListLLCShareholders not implemented")
}
func (UnimplementedEntityServiceServer) EntityExists(context.Context, *EntityExistsRequest) (*EntityExistsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method EntityExists not implemented")
}
