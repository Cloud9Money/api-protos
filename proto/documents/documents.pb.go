...
type Document struct {
	...
	// Document type (e.g., "ID_FRONT", "ID_BACK", "PASSPORT", "SELFIE", "PROOF_OF_ADDRESS")
...
const file_documents_documents_proto_rawDesc = "" +
	"\n" +
	"\x19documents/documents.proto\x12\x10cloud9.documents\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc0\x02\n" +
	"\bDocument\x12\x0e\n" +
