...
func (UnimplementedAuthServiceServer) GetUserByEntityID(context.Context, *GetUserByEntityIDRequest) (*GetUserByEntityIDResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUserByEntityID not implemented")
}
...
func (UnimplementedAuthServiceServer) SendOTPToContact(context.Context, *SendOTPToContactRequest) (*SendOTPToContactResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SendOTPToContact not implemented")
}
func (UnimplementedAuthServiceServer) VerifyContactOTP(context.Context, *VerifyContactOTPRequest) (*VerifyContactOTPResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method VerifyContactOTP not implemented")
}
