...
func (x *SendTransactionNotificationRequest) GetCompletedAt() string {
	if x != nil {
...
func (x *SendTransactionNotificationRequest) GetFeeAmount() float64 {
	if x != nil {
		return x.FeeAmount
	}
	return 0
...
func (x *SendTransactionNotificationRequest) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
