...
const file_accounts_accounts_proto_rawDesc = "" +
	"\n" +
	"\x17accounts/accounts.proto\x12\x0fcloud9.accounts\x1a\x13common/common.proto\x1a\x12common/money.proto\x1a\x14common/address.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xdf\a\n" +
	"\aAccount\x123\n" +
	...
	"\faccount_name\x18\x12 \x01(\tR\vaccountName\x12!\n" +
	"\fphone_number\x18\x13 \x01(\tR\vphoneNumber\"\xc4\x03\n" +
	"\rAccountHolder\x12-\n" +
	...
	"\x06errors\x18\x05 \x03(\tR\x06errors\"R\n" +
	"\x15GetPaymentLinkRequest\x12\x1d\n" +
	"\n" +
	"cloud9_tag\x18\x01 \x01(\tR\tcloud9Tag\x12\x1a\n" +
	"\bcurrency\x18\x02 \x01(\tR\bcurrency\"\xee\x02\n" +
	"\x16GetPaymentLinkResponse\x12\x17\n" +
	"\alink_id\x18\x01 \x01(\tR\x06linkId\x12\x1d\n" +
	"\n" +
	"account_id\x18\x02 \x01(\tR\taccountId\x12.\n" +
	"\x13provider_account_id\x18\x03 \x01(\tR\x11providerAccountId\x12!\n" +
	"\fdisplay_name\x18\x04 \x01(\tR\vdisplayName\x12\x1d\n" +
	"\n" +
	"cloud9_tag\x18\x05 \x01(\tR\tcloud9Tag\x12\x1a\n" +
	"\bcurrency\x18\x06 \x01(\tR\bcurrency\x12*\n" +
	"\x11has_preset_amount\x18\a \x01(\bR\x0fhasPresetAmount\x12#\n" +
	"\rpreset_amount\x18\b \x01(\x01R\fpresetAmount\x12 \n" +
	"\vdescription\x18\t \x01(\tR\vdescription\x12\x1b\n" +
	"\tis_active\x18\n" +
	" \x01(\bR\bisActive\"6\n" +
	"\x15GetEntityByTagRequest\x12\x1d\n" +
	"\n" +
	"cloud9_tag\x18\x01 \x01(\tR\tcloud9Tag\"5\n" +
	"\x16GetEntityByTagResponse\x12\x1b\n" +
	...
	"\fCloseAccount\x12$.cloud9.accounts.CloseAccountRequest\x1a%.cloud9.accounts.CloseAccountResponse\x12a\n" +
	"\x0eGetPaymentLink\x12&.cloud9.accounts.GetPaymentLinkRequest\x1a'.cloud9.accounts.GetPaymentLinkResponse\x12a\n" +
	"\x0eGetEntityByTag\x12&.cloud9.accounts.GetEntityByTagRequest\x1a'.cloud9.accounts.GetEntityByTagResponseB=Z;github.com/Cloud9Money/api-protos/proto/accounts;accountspbb\x06proto3"
...
var file_accounts_accounts_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_accounts_accounts_proto_goTypes = []any{
	...
	(*GetEntityByTagRequest)(nil),     // 29: cloud9.accounts.GetEntityByTagRequest
	(*GetEntityByTagResponse)(nil),    // 30: cloud9.accounts.GetEntityByTagResponse
	(*common.Metadata)(nil),           // 31: cloud9.common.Metadata
	(*common.Money)(nil),              // 32: cloud9.common.Money
	(common.Jurisdiction)(0),          // 33: cloud9.common.Jurisdiction
	(*timestamppb.Timestamp)(nil),     // 34: google.protobuf.Timestamp
	(*common.PersonName)(nil),         // 35: cloud9.common.PersonName
	(*common.Contact)(nil),            // 36: cloud9.common.Contact
	(*common.Address)(nil),            // 37: cloud9.common.Address
	(*common.Identification)(nil),     // 38: cloud9.common.Identification
	(*common.PaginationRequest)(nil),  // 39: cloud9.common.PaginationRequest
	(*common.PaginationResponse)(nil), // 40: cloud9.common.PaginationResponse
}
var file_accounts_accounts_proto_depIdxs = []int32{
	31, // 0: cloud9.accounts.Account.metadata:type_name -> cloud9.common.Metadata
	...
	32, // 3: cloud9.accounts.Account.balance:type_name -> cloud9.common.Money
	32, // 4: cloud9.accounts.Account.available_balance:type_name -> cloud9.common.Money
	33, // 5: cloud9.accounts.Account.jurisdiction:type_name -> cloud9.common.Jurisdiction
	...
	34, // 8: cloud9.accounts.Account.opened_at:type_name -> google.protobuf.Timestamp
	34, // 9: cloud9.accounts.Account.closed_at:type_name -> google.protobuf.Timestamp
	34, // 10: cloud9.accounts.Account.last_transaction_at:type_name -> google.protobuf.Timestamp
	0,  // 11: cloud9.accounts.Account.provider:type_name -> cloud9.accounts.AccountProvider
	35, // 12: cloud9.accounts.AccountHolder.name:type_name -> cloud9.common.PersonName
	36, // 13: cloud9.accounts.AccountHolder.contact:type_name -> cloud9.common.Contact
	37, // 14: cloud9.accounts.AccountHolder.address:type_name -> cloud9.common.Address
	38, // 15: cloud9.accounts.AccountHolder.identification:type_name -> cloud9.common.Identification
	34, // 16: cloud9.accounts.AccountHolder.date_of_birth:type_name -> google.protobuf.Timestamp
	...
	33, // 20: cloud9.accounts.CreateAccountRequest.jurisdiction:type_name -> cloud9.common.Jurisdiction
	32, // 21: cloud9.accounts.CreateAccountRequest.initial_deposit:type_name -> cloud9.common.Money
	...
	39, // 25: cloud9.accounts.ListAccountsRequest.pagination:type_name -> cloud9.common.PaginationRequest
	6,  // 26: cloud9.accounts.ListAccountsResponse.accounts:type_name -> cloud9.accounts.Account
	40, // 27: cloud9.accounts.ListAccountsResponse.pagination:type_name -> cloud9.common.PaginationResponse
	...
	36, // 31: cloud9.accounts.AccountUpdate.contact:type_name -> cloud9.common.Contact
	37, // 32: cloud9.accounts.AccountUpdate.address:type_name -> cloud9.common.Address
	...
	32, // 35: cloud9.accounts.GetBalanceResponse.balance:type_name -> cloud9.common.Money
	32, // 36: cloud9.accounts.GetBalanceResponse.available_balance:type_name -> cloud9.common.Money
	32, // 37: cloud9.accounts.DebitAccountRequest.amount:type_name -> cloud9.common.Money
	32, // 38: cloud9.accounts.DebitAccountRequest.provider_balance:type_name -> cloud9.common.Money
	32, // 39: cloud9.accounts.DebitAccountResponse.new_balance:type_name -> cloud9.common.Money
	32, // 40: cloud9.accounts.DebitAccountResponse.previous_balance:type_name -> cloud9.common.Money
	32, // 41: cloud9.accounts.CreditAccountRequest.amount:type_name -> cloud9.common.Money
	32, // 42: cloud9.accounts.CreditAccountRequest.provider_balance:type_name -> cloud9.common.Money
	32, // 43: cloud9.accounts.CreditAccountResponse.new_balance:type_name -> cloud9.common.Money
	32, // 44: cloud9.accounts.CreditAccountResponse.previous_balance:type_name -> cloud9.common.Money
	32, // 45: cloud9.accounts.ValidateAccountRequest.amount:type_name -> cloud9.common.Money
	...
	32, // 48: cloud9.accounts.ValidateAccountResponse.available_balance:type_name -> cloud9.common.Money
	...
	29, // 59: cloud9.accounts.AccountService.GetEntityByTag:input_type -> cloud9.accounts.GetEntityByTagRequest
	11, // 60: cloud9.accounts.AccountService.GetAccount:output_type -> cloud9.accounts.GetAccountResponse
	20, // 61: cloud9.accounts.AccountService.GetBalance:output_type -> cloud9.accounts.GetBalanceResponse
	26, // 62: cloud9.accounts.AccountService.ValidateAccount:output_type -> cloud9.accounts.ValidateAccountResponse
	22, // 63: cloud9.accounts.AccountService.DebitAccount:output_type -> cloud9.accounts.DebitAccountResponse
	24, // 64: cloud9.accounts.AccountService.CreditAccount:output_type -> cloud9.accounts.CreditAccountResponse
	9,  // 65: cloud9.accounts.AccountService.CreateAccount:output_type -> cloud9.accounts.CreateAccountResponse
	13, // 66: cloud9.accounts.AccountService.ListAccounts:output_type -> cloud9.accounts.ListAccountsResponse
	16, // 67: cloud9.accounts.AccountService.UpdateAccount:output_type -> cloud9.accounts.UpdateAccountResponse
	18, // 68: cloud9.accounts.AccountService.CloseAccount:output_type -> cloud9.accounts.CloseAccountResponse
	28, // 69: cloud9.accounts.AccountService.GetPaymentLink:output_type -> cloud9.accounts.GetPaymentLinkResponse
	30, // 70: cloud9.accounts.AccountService.GetEntityByTag:output_type -> cloud9.accounts.GetEntityByTagResponse
